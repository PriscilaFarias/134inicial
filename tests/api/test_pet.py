...
def teste_incluir_pet():
    ...
    pet_id_esperado = 2890821
    pet_nome_esperado = "Bruce"
    ...
    resultado_obtido = requests.post(
        url=url,
        headers=headers,
        data=open('C:\\Users\\user\\PycharmProjects\\134inicial\\vendors\\json\\pet1.json')
...
def teste_alterar_pet():
    ...
    resultado_obtido = requests.put(
        url=url,
        headers=headers,
        data=open("C:\\Users\\user\\PycharmProjects\\134inicial\\vendors\\json\\pet2.json")
    )
    print(resultado_obtido)
    corpo_do_resultado_obtido = resultado_obtido.json()
    print(json.dumps(corpo_do_resultado_obtido, indent=4))
...
@pytest.mark.parametrize('pet_id,category_id,category_name,pet_name,tags_id,tags_name,status', ler_csv('C:\\Users\\user\\PycharmProjects\\134inicial\\vendors\\csv\\massa_incluir_pet.csv'))
def teste_incluir_pet_em_massa(pet_id,category_id,category_name,pet_name,tags_id,tags_name,status):
    #Os daddos de entrada tmb servirão como resultados esperados, visto que o retorno é um eco
    corpo_json = '{'
